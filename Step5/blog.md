...
2. Can one comment have many blogs? (Yes)

You'll then be able to say that:

1. **[blog] has many [comments]**
2. And on the other side, **[comments] belongs to [blog]**
...
1. Can one blog have many comments? YES
2. Can one comments have many blog? NO

-> Therefore,
-> An blog HAS MANY comments
-> An comments BELONGS TO an blog
